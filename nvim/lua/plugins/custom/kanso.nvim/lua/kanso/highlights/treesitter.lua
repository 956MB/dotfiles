...
function M.setup(colors, config)
    ...
    return {
        -- Base fallbacks — Neovim only links these automatically in colors/vim.lua (the built-in
        -- colorscheme). Custom colorschemes must define them explicitly or they remain uncolored.
