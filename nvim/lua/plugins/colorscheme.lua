...
--
--                 -- Telescope (making the border lines disappear by matching the bg)
...
--
--                 -- Trouble (quickfix)
--                 TroubleNormal = { fg = c.vscFront, bg = bg1 },
--                 TroubleCount = { fg = c.vscFront, bg = 'NONE' },
--                 TroubleDirectory = { fg = c.vscBlue, bg = 'NONE' },
--                 TroubleFilename = { fg = c.vscBlue, bg = 'NONE' },
--
--                 -- quicker.nvim (quickfix)
--                 QuickFixHeaderHard = { fg = '#444444', bg = bufferBgSel },
--                 QuickFixHeaderSoft = { fg = '#444444', bg = bufferBgSel },
--                 QuickFixFilename = { fg = c.vscBlue, bg = bufferBgSel },
--
...
--                 SpecialComment = { fg = '#666666', bg = 'NONE', italic = true },
--                 ['@comment'] = { fg = '#666666', bg = 'NONE', italic = true },
--
--                 -- Scrollbar
...
--                 -- BufferLine
--                 --
--                 BufferLineFill = { fg = 'NONE', bg = bufferBgSel },
--                 BufferLineDuplicate = { fg = '#666666', bg = bufferBgSel },
--                 BufferLineDuplicateSelected = { fg = c.vscSplitLight, bg = 'NONE' },
--                 BufferLineBackground = { fg = '#666666', bg = bufferBgSel },
--                 BufferLineSeperatorVisible = { fg = '#A733FF', bg = '#33A7FF' },
--                 BufferLineGroupSeperator = { fg = '#FF33A7', bg = '#A7FF33' },
--                 BufferLineSeparator = { fg = bufferBgSel, bg = bufferBgSel },
--                 BufferLineBufferSelected = { fg = c.vscFront, bg = bufferBgSel },
--                 BufferLineIndicatorSelected = { fg = bufferBgSel, bg = bufferBgSel },
--
--                 BufferLineDiagnostics = { fg = c.vscRed, bg = bufferBgSel },
...
--                 BufferLineBufferVisible = { fg = c.vscFront, bg = scrollBg },
--                 BufferLineSeperator = { fg = '#33A7FF', bg = '#FFA733' },
--                 BufferLineDiagnostic = { fg = '#A7FF33', bg = '#FF33A7' },
--                 BufferLinePick = { fg = scrollBg, bg = bufferBgSel },
--                 BufferLinePickSelected = { fg = c.vscRed, bg = bufferBgSel },
...
--                 BufferLineError = { fg = '#666666', bg = bufferBgSel },
--                 BufferLineErrorDiagnostic = { fg = c.vscRed, bg = bufferBgSel },
--                 BufferLineErrorVisible = { fg = '#FF337F', bg = c.vscYellow },
--                 BufferLineErrorDiagnosticVisible = { fg = '#7FFF33', bg = '#337FFF' },
--                 BufferLineErrorSelected = { fg = c.vscRed, bg = bufferBgSel },
--                 BufferLineErrorDiagnosticSelected = { fg = c.vscRed, bg = bufferBgSel },
--                 BufferLineWarning = { fg = '#555555', bg = bufferBgSel },
--                 BufferLineWarningVisible = { fg = '#A733FF', bg = '#33A7FF' },
--                 BufferLineWarningDiagnosticVisible = { fg = '#FF33A7', bg = '#A7FF33' },
--                 BufferLineWarningDiagnostic = { fg = c.vscYellowOrange, bg = bufferBgSel },
--                 BufferLineWarningSelected = { fg = c.vscFront, bg = bufferBgSel },
--                 BufferLineWarningDiagnosticSelected = { fg = c.vscYellowOrange, bg = bufferBgSel },
--                 BufferLineInfo = { fg = scrollBg, bg = bufferBgSel },
--                 BufferLineInfoVisible = { fg = c.vscRed, bg = bufferBgSel },
...
--                 BufferLineModified = { fg = c.vscFront, bg = bufferBgSel },
--                 BufferLineModifiedSelected = { fg = c.vscFront, bg = bufferBgSel },
--
--                 BufferLineSeparatorVisible = { fg = '#00ff00', bg = 'NONE' },
--                 BufferLineBackgroundSelected = { fg = '#00ffff', bg = '#0d9f99' },
--                 -- BufferLineDevIcon = { fg = '#019833', bg = '#00ffff' },
--                 -- BufferLineDevIconSelected = { fg = '#019833', bg = '#00ffff' },
--                 -- BufferLineDevIconVim = { fg = '#019833', bg = 'NONE' },
--                 -- BufferLineDevIconVimSelected = { fg = '#019833', bg = 'NONE' },
--                 -- BufferLineDevIconLua = { fg = '#51A0CF', bg = 'NONE' },
--                 -- BufferLineDevIconLuaSelected = { fg = '#51A0CF', bg = 'NONE' },
--                 -- BufferLineDevIconPython = { fg = '#FFD43B', bg = 'NONE' },
--                 -- BufferLineDevIconPythonSelected = { fg = '#FFD43B', bg = 'NONE' },
--                 -- BufferLineDevIconRust = { fg = '#DEA584', bg = 'NONE' },
--                 -- BufferLineDevIconRustSelected = { fg = '#DEA584', bg = 'NONE' },
--                 -- BufferLineDevIconJavaScript = { fg = '#F7DF1E', bg = 'NONE' },
--                 -- BufferLineDevIconJavaScriptSelected = { fg = '#F7DF1E', bg = 'NONE' },
--                 -- BufferLineDevIconTypeScript = { fg = '#007ACC', bg = 'NONE' },
--                 -- BufferLineDevIconTypeScriptSelected = { fg = '#007ACC', bg = 'NONE' },
--                 -- BufferLineDevIconHtml = { fg = '#E34F26', bg = 'NONE' },
--                 -- BufferLineDevIconHtmlSelected = { fg = '#E34F26', bg = 'NONE' },
--                 -- BufferLineDevIconCss = { fg = '#1572B6', bg = 'NONE' },
--                 -- BufferLineDevIconCssSelected = { fg = '#1572B6', bg = 'NONE' },
--                 -- BufferLineDevIconJson = { fg = '#FAC31D', bg = 'NONE' },
--                 -- BufferLineDevIconJsonSelected = { fg = '#FAC31D', bg = 'NONE' },
--                 -- BufferLineDevIconMarkdown = { fg = '#519ABA', bg = 'NONE' },
--                 -- BufferLineDevIconMarkdownSelected = { fg = '#519ABA', bg = 'NONE' },
--                 -- BufferLineDevIconC = { fg = '#599EDD', bg = 'NONE' },
--                 -- BufferLineDevIconCSelected = { fg = '#599EDD', bg = 'NONE' },
--                 -- BufferLineDevIconCpp = { fg = '#00599C', bg = 'NONE' },
--                 -- BufferLineDevIconCppSelected = { fg = '#00599C', bg = 'NONE' },
--                 -- BufferLineDevIconJava = { fg = '#007396', bg = 'NONE' },
--                 -- BufferLineDevIconJavaSelected = { fg = '#007396', bg = 'NONE' },
--                 -- BufferLineDevIconGo = { fg = '#00ADD8', bg = 'NONE' },
--                 -- BufferLineDevIconGoSelected = { fg = '#00ADD8', bg = 'NONE' },
--                 -- BufferLineDevIconBash = { fg = '#4EAA25', bg = 'NONE' },
--                 -- BufferLineDevIconBashSelected = { fg = '#4EAA25', bg = 'NONE' },
--                 -- BufferLineDevIconDefault = { fg = '#ff0000', bg = 'NONE' },
--                 -- BufferLineDevIconDefaultSelected = { fg = '#00ff00', bg = 'NONE' },
--
--                 -- Diffview
